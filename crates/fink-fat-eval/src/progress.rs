...
//!
//! Always active in `fink-fat-eval` — no CLI flag required.
//! The shared [`MultiProgress`] handle is passed to [`crate::logging::init_logging`]
//! so that log lines are printed above the active bars.
