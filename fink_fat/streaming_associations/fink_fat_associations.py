...
def fink_fat_association(
    ...
    ...     pd.Series([
    ...         46.328490, 108.603010, 97.600172, 98.928007, 2.05, 110.359871,
    ...         0.254, 48.147, 34.741, 0.198, 0.192,
    ...         316.035113, 316.0302983, 347.8101124, 351.2340633, 350.9250203
    ...     ]),
    ...     pd.Series([
    ...         18.833964, -67.879693, 32.281571, 23.230676, 3.01, -68.051308,
    ...
    ...     ]),
    ...     pd.Series([
    ...         2460139.8717433237, 2460140.8717433237, 2460139.9917433237, 2460139.8717433237, 2460140.8717432237, 2460160.94413407,
    ...
    3                           []
    4                           []
    5     [2.9706081940923175e-06]
    6                           []
    7                           []
    8                           []
    9                           []
    10                          []
    11         [0.866730648677894]
    12        [0.6532971697206779]
    13                          []
    14                          []
    15                          []
    dtype: object
    ...
    >>> flags, estimator_id, ffdistnr = fink_fat_association(
    ...     pd.Series([
    ...         54.700455, 108.603010, 97.600172, 110.400536, 2.05, 46.55802234,
    ...         0.254, 48.147, 34.741, 0.198, 0.192,
    ...         316.035113, 316.0302983, 347.8101124, 351.2340633, 350.9250203
    ...     ]),
    ...     pd.Series([
    ...         21.481771, -67.879693, 32.281571, -68.058235, 3.01, 18.91096543,
    ...         1.036, 65.036, -0.214, 0.987, 0.943,
    ...         -5.1239501, -5.1298901, 3.2216515, -3.9021139, -0.5572286
    ...     ]),
    ...     pd.Series([
    ...
    ...     ]),
    ...     pd.Series([
    ...         2460160.58482852, 2460140.8717433237, 2460139.9917433237, 2460160.94413407, 2460140.8717432237, 2460140.4217432237,
    ...         2460160.0004537117, 2460160.0007537117, 2460160.0009437117, 2460160.0000537117, 2460160.0009537117,
    ...         2459459.7334491, 2459459.7747685, 2459459.8152199, 2459459.8147454, 2459459.8147454
    ...     ]),
    ...     pd.Series([
