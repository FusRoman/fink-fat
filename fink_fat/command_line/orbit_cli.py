...
def cluster_mode(
    ...
    >>> cluster_mode(config, tr)
        trajectory_id  ref_epoch    a  ...       last_jd   last_mag  last_fid
    0              0       -1.0 -1.0  ...  2.459715e+06  18.274776         2
    1              1       -1.0 -1.0  ...  2.459715e+06  15.062812         2
    2              3       -1.0 -1.0  ...  2.459715e+06  19.020517         2
    3              2       -1.0 -1.0  ...  2.459715e+06  18.537624         2
    <BLANKLINE>
    [4 rows x 20 columns]
    """
